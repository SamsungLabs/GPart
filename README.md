...
Copy the `peft` folder from this repository (`src/peft`) into your project:

```bash
# From your project root
cp -r /path/to/GPart/src/peft YOUR_SRC_PATH
```

Or simply copy the folder manually into your desired location.

#### Step 2: (Optional) Configure uv for local PEFT
